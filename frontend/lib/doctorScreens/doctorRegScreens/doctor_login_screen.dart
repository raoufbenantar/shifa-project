...
import '../doctorLoginScreen/auth_primary_button.dart';
import '../doctorLoginScreen/auth_social_button.dart';
import '../doctorLoginScreen/doctor_login_bloc.dart';
import '../doctorLoginScreen/doctor_login_event.dart';
import '../doctorLoginScreen/doctor_login_remote_datasource.dart';
import '../doctorLoginScreen/doctor_login_repository_impl.dart';
import '../doctorLoginScreen/doctor_login_state.dart';
import '../doctorLoginScreen/doctor_login_usecase.dart';
import 'doctor_signup_screen.dart'; // ← added for Register navigation
      ...
      create: (_) => DoctorLoginBloc(
        DoctorLoginUseCase(
          DoctorLoginRepositoryImpl(
            DoctorLoginRemoteDataSourceMock(), // swap → real datasource
          ),
        ),
      ),
